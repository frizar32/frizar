...
if (!empty($arResult['ITEMS']))
{
	...
	<div class="bx_item_list_gift_horizontal col<? echo $arParams['LINE_ELEMENT_COUNT']; ?>">

            <? if(empty($arParams['HIDE_BLOCK_TITLE']) || $arParams['HIDE_BLOCK_TITLE'] == 'N'){ ?>
                <div class="bx_item_list_title bxr-color-button">
                                ...
                                <div class="bx_catalog_item_controls bxr-element-action" id="<?=$arItemIDs["BASKET_ACTIONS"]?>">
                                    <?if ($arItem['CAN_BUY']
                                        ...
                                        <form class="bxr-basket-action bxr-basket-group bxr-currnet-torg" action="">
                                            ...
                                            <button id="<? echo $arItemIDs['BUY_LINK']; ?>" class="bxr-color-button bxr-color-button-small-only-icon bxr-basket-add" onclick="yaCounter49057298.reachGoal('add_to_cart'); return true;">
                                ...
                                <div class="bx_catalog_item_controls bxr-element-action no_touch" id="<?=$arItemIDs["BASKET_ACTIONS"]?>">
                                    <div class="bx_catalog_item_controls_blocktwo">
                                        <form class="bxr-basket-action bxr-basket-group bxr-currnet-torg" action="">
                                            ...
                                            <a id="<? echo $arItemIDs['BUY_LINK']; ?>" href="javascript:void(0)" class="bxr-color-button bxr-color-button-small-only-icon bxr-basket-add" onclick="yaCounter49057298.reachGoal('add_to_cart'); return true;" data-href="<? echo $arItem['DETAIL_PAGE_URL']; ?>">
                                                <?echo('' != $arParams['MESS_BTN_BUY'] ? $arParams['MESS_BTN_BUY'] : GetMessage('CT_BCS_TPL_MESS_BTN_BUY'));?>
                                            </a>
