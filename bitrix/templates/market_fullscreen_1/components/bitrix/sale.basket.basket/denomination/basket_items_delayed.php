		...
		<tbody>
			...
			?>
				<tr id="<?=$arItem["ID"]?>">
					...
					?>
						<td class="control">
							<a class="bxr-icon-baske-delay-big-baske" href="<?=str_replace("#ID#", $arItem["ID"], $arUrls["add"])?>"><span class="fa fa-shopping-cart" aria-hidden="true"></span></a>
							<?
							if ($bDeleteColumn):
							?>
								<a class="bxr-icon-button-delete-big-baske"  href="<?=str_replace("#ID#", $arItem["ID"], $arUrls["delete"])?>"><span class="fa fa-close" aria-hidden="true"></span></a><br />
							<?
							endif;
							?>
						</td>
