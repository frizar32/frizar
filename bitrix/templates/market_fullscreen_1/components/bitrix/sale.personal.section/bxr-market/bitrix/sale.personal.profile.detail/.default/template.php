...
<div class="row">
	...
	<form method="post"  class="sale-profile-detail-form" action="<?=POST_FORM_ACTION_URI?>" enctype="multipart/form-data">
		...
		<div class="sale-personal-profile-detail-form-title-row">
			<h4>
				<b><?= Loc::getMessage('SPPD_PROFILE_NO', array("#ID#" => $arResult["ID"]))?></b>
			</h4>
		</div>
		<div class="form-group">
			<label class="sale-personal-profile-detail-form-label"><?=Loc::getMessage('SALE_PERS_TYPE')?></label>
			<div class="">
				<?=$arResult["PERSON_TYPE"]["NAME"]?>
			</div>
		</div>		
		<div class="form-group">
			<label class="sale-personal-profile-detail-form-label" for="sale-personal-profile-detail-name">
		...
		?>
		<div class="sale-personal-profile-btn-block">
			<input type="submit" class="btn bxr-color-button" name="save" value="<?echo GetMessage("SALE_SAVE") ?>">
			&nbsp;
			<input type="submit" class="btn bxr-color-button"  name="apply" value="<?=GetMessage("SALE_APPLY")?>">
			&nbsp;
			<input type="submit" class="btn bxr-color-button"  name="reset" value="<?echo GetMessage("SALE_RESET")?>">
		</div>
	</form>
    </div>
</div>
