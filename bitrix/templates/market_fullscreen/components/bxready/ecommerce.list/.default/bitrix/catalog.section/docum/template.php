	...
	<div class="row bxr-list"><?
		...
		<div id="sl_<?=$unicumID?>">
			...
			foreach ($arResult["ITEMS"] as $cell => $arItem):
				...
				?><div id="<?=$strMainID?>" class="t_<?=$unicumID?> col-lg-<?=$arParams["BXREADY_LIST_LG_CNT"]?> col-md-<?=$arParams["BXREADY_LIST_MD_CNT"]?> col-sm-6 col-xs-12"><?
				?>
...
var google_tag_params = {
	ecomm_prodid: [<?=(is_array($prodIDs) ? implode(",", $prodIDs) : "")?>],
<?if (isset($_GET['q'])):?>
