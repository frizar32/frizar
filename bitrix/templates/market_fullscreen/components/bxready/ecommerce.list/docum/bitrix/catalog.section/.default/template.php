...
$arParams["BXREADY_ELEMENT_DRAW"] = "system#ecommerce_pdf";
...
if (count($arResult["ITEMS"])>0):
        ...
        <?endif;?>
	<div class="row bxr-list" data-type="1">


            <?
            if ($arParams["BXREADY_LIST_SLIDER"] == "Y") {
                echo '<div id="sl_'.$unicumID.'">';
            } else {
			...
			foreach ($arResult["ITEMS"] as $cell => $arItem):
                ...
                pdfToPng($arItem['PROPERTIES']['PDF'], $arItem);
                ...
                <?
                    ...
                    // вызывается bitrix/tools/bxerady/library/elements
