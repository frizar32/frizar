...
?>
<div data-bimgsrc="<?=$bImgSrc;?>" data-bimg="<?=$bIMG;?>" data-lg="<?if(!empty($arParams["HOVER_MENU_COL_LG"])) echo $arParams["HOVER_MENU_COL_LG"];?>" data-md="<?if(!empty($arParams["HOVER_MENU_COL_MD"])) echo $arParams["HOVER_MENU_COL_MD"];?>" data-sm="<?if(!empty($arParams["HOVER_MENU_COL_SM"])) echo $arParams["HOVER_MENU_COL_SM"];?>" data-xs="<?if(!empty($arParams["HOVER_MENU_COL_XS"])) echo $arParams["HOVER_MENU_COL_XS"];?>" class="col-w-lg-9 col-w-md-9  bxr-list-hover-menu <?if($arParams['STYLE_MENU'] == "colored_light") {echo "menu-arrow-top";} ?>">
        ...
        <div class="bxr-element-image">            
            <?
                ...
                if(isset($v1["IMG"]) && !empty($v1["IMG"])) {
                    ...
                    $s_ico = "<img alt='".$v1["TEXT"]."' src='" . $img['src'] . "'>";
                }
            ?>
            <?if($s_ico != ""):?>
                ...
                <?
                    ...
                    if($isIco != "N" && $isIco != "IMG") {
                        if(isset($v1[$arColor['ico']]) && !empty($v1[$arColor['ico']])) {
                            ...
                            $s_ico = "<img alt='".$v1["TEXT"]."' class='bxr-ico-menu' src='" . $img['src'] . "'>";
                        }
