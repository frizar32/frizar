                ...
                <div class="bxr-sender-subscribe-container column container-fluid">
                    <div class="row">
                        ...
                        <div class="col-md-12 bxr-input-group">
                            <input style="width:180px;" class="bxr-form-control" type="email" name="SENDER_SUBSCRIBE_EMAIL" value="<?=$arResult["EMAIL"]?>" title="<?=GetMessage("subscr_form_email_title")?>" placeholder="<?=htmlspecialcharsbx(GetMessage('subscr_form_email_title'))?>">
							<p style="margin-top:7px;font-weight:600;">Введите проверочный код!</p>
							

<img style="" src="/bitrix/tools/captcha.php?captcha_code=<?=htmlspecialchars($cpt->GetCodeCrypt());?>">
<input style="margin-top:7px;width:180px;float:left;margin-bottom:7px;" id="captcha_word" name="captcha_word" type="text">
<input  name="captcha_code" value="<?=htmlspecialchars($cpt->GetCodeCrypt());?>" type="hidden">
                        </div>
						
						
                        <div class="col-md-12 bxr_subscribe_submit_container" style="margin-top:0px;">
