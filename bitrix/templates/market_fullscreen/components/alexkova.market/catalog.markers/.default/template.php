...
<div id="bxr-markers-container">
	...
	$firstMarker = false?>
	<div class="row hidden-xs" id="bxr-markers" style="display: none;">
	...
	<div class="col-xs-12 hidden-lg hidden-md hidden-sm" style="display: none;">
			...
			<div class="bxr-marker-flex-header">
				<h2 class="color_style"><?=GetMessage('NEWPRODUCT_BUTTON')?></h2>
				<a href="/prod_selections/is_new/">Смотреть все</a>
			</div>
		...
		case "RECCOMEND":?>
			...
			<div class="bxr-marker-flex-header">
				<h2 class="color_style"><?=GetMessage('RECOMMENDED_BUTTON')?></h2>
				<a href="/prod_selections/is_popular/">Смотреть все</a>
			</div>
		...
		case "HIT":?>
			...
			<h2 class="color_style"><?=GetMessage('SALELEADER_BUTTON')?></h2>
