...
<div class="col-xs-12<?=($arParams["THEME"] == 'default') ?' bxr-border-color':' bxr-color-flat'?> bxr-sort-panel">
        <div class="row">
                <div class="col-xs-12 col-sm-5 col-md-5 text-xs-left text-md-left">
                        <a class="bxr-sortbutton active asc last filter-mobail" id="filter_mobail" rel="nofollow">
                                Фильтр<i class="fa fa-triangle triangle-up"></i>                        
                        </a>
                        <span class="hidden-sm hidden-lg hidden-md hidden-sd hidden-mobail text-xs-right"><?=GetMessage("KZNC_SORT_BY")?></span>
                ...
                <?endif;*/?>
                <?if ($viewShow):?>
                <div class="col-xs-12 col-sm-7 col-md-7 text-right hidden-mobail">
