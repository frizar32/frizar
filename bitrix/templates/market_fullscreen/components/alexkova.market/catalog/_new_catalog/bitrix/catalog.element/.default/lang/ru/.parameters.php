...
$MESS["CP_BCE_TPL_SHOW_AVAILABLE"] = "Показывать индикатор наличия";
...
$MESS["CP_BCE_TPL_MESS_BTN_SUBSCRIBE_DEFAULT"] = "Поставляется под заказ";
...
$MESS["CP_BC_TPL_COMPARE_SCROLL_UP"] = "Прокрутка к списку Отложенные товары при повторном нажатии на кнопки сравнения";
?>
