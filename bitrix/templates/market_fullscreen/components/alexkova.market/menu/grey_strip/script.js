    ...
    window.BXReady.Market.Menu =  {
            ...
            submenyHTML = "";
                $('ul.bxr-flex-menu>li').each(function(){
                    ...
                    if ($(this).data('nomobile') != 1 && !$(this).is('#bxr-flex-menu-li') && !$(this).is('.li-visible')){
                        ...
                        submenyHTML += $(this).children( ".link").prop('outerHTML');
                        submenyHTML += '</div>';
       ...
       initMobileMenuEvents: function(){
            $(document).on(
                ...
                '#bxr-menuitem',
                function(){           
					if ($('#bxr-mobile-menu-body').hasClass('bsnav-mobile')){
						$('#bxr-mobile-menu-body').removeClass('bsnav-mobile');
						$('.bsnav-mobile-overlay').remove();
						
					}else{
						$('#bxr-mobile-menu-body').addClass('bsnav-mobile');
						$('.bxr-container-headline').append('<div class="bsnav-mobile-overlay"></div>');
					}
            ...
            $(document).on(
                'click',
                '#bxr-mobile-menu-content > div[data-item]',
                function(){
                    if ($(this).parent().is('div.submenu_item'))
                        return;
					
					if (!$(this).next().is('div.submenu_item'))
					{
                        return;
					}
					
					$(this).toggleClass('active').siblings().removeClass('active');
					$(this).siblings('.submenu_item').slideUp();

                    nItem = $(this).parent().data('item');

					if($(this).hasClass('active')){
						$(this).next('.submenu_item').slideDown(200, function(){
