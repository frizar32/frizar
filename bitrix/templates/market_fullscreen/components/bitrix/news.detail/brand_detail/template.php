...
<div class="news_detail_wrapp ">
	...
	<?} else { ?>
        <div class="detail_text is_cuted">У нас на сайте вы можете купить товары известного бренда <?=$arResult['NAME'];?> по минимальной цене. Осуществляем доставку по всей России. Подробности по телефону <a href="+74832586633">+7 (4832) 58-66-33</a></div>
    <?}?>
	<div class="clear"></div>
