...
$MESS["SOA_ERROR_ORDER"] = "Ваш заказ успешно создан. Пожалуйста авторизуйтесь.";
//$MESS["SOA_ERROR_ORDER_LOST"] = "Заказ №#ORDER_ID# не найден.";
$MESS["SOA_ERROR_ORDER_LOST"] = "Заказ №#ORDER_ID# создан.";
...
$MESS["SOA_ERROR_ORDER_LOST1"] = "Пожалуйста авторизуйтесь для просмотра заказа";
