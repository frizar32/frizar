...
$(document).on('click', '.popup-window-overlay', function(e){
    if(e.target == this){
        $('.popup-window-overlay, .popup-window').hide();
    }
});
...
// function calcPosBasketBar() {
//     if($("div").is(".bxr-slider")) {
//         var posSlider = $('.bxr-slider').offset().top;
//         var posBasketBar = $('#bxr-basket-container').offset().top;
//         var scrollWindow = $(window).scrollTop();
//         var sliderToTop = posSlider - scrollWindow;

//         if(posBasketBar <= sliderToTop) {
//             $('#bxr-basket-container').css({ 'top' : sliderToTop+'px'});
//         }
//     }
// }


$('.bx-sidebar-block .open-form-help').attr('onclick','yaCounter49057298.reachGoal("choose_help")');
