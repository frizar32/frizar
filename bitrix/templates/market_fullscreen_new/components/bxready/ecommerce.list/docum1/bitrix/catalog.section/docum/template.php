		...
		<div id="sl_<?=$unicumID?>">
			...
			foreach ($arResult["ITEMS"] as $cell => $arItem):
				...
				?>
				    ...
				    <?/**/?>
				    <div class="bxr-ecommerce-v1" data-uid="1" data-resize="1" style="height: 292px;">
						<div class="bxr-element-container" style="height: 304px;">
							<div class="bxr-element-image">
								<div href="<?=$arItem['DETAIL_PAGE_URL']?>">
                                    <img class="docum_img" src="<?=$arItem['PREVIEW_PICTURE']['SRC']?>" alt="<?=$arItem['NAME']?>" title="<?=$arItem['NAME']?>">
                                </div>
							</div>
						...
						<div class="bxr-element-name" style="height: 80px;">
							<span href="<?=$arItem['DETAIL_PAGE_URL']?>" title="<?=$arItem['NAME']?>"><?=$arItem['NAME']?></span>			
			            </div>

						<div class="bxr-element-action" >
						<?/* echo '<a class="bxr-color-button" href="'.CFile::GetPath($arItem["PROPERTIES"]["PDF"]["VALUE"]).'">Скачать</a> '; */?>              
						<a class="bxr-color-button" href="<? echo ''.CFile::GetPath($arItem["PROPERTIES"]["PDF"]["VALUE"]).''; ?>" download="<?=$arItem['NAME']?>.pdf">Скачать</a>
						</div>
					</div>
					<?/**/?>
