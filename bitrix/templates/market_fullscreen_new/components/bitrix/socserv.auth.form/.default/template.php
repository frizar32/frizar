...
<div class="bx-auth-serv-icons">
	...
	?>
        <a title="<?=htmlspecialcharsbx($service["NAME"])?>" href="javascript:void(0)" <?=$onClickEvent?> id="bx_auth_href_<?=$arParams["SUFFIX"]?><?=$service["ID"]?>"><i class="bx-ss-icon <?=htmlspecialcharsbx($service["ICON"])?>"></i><span><?=htmlspecialcharsbx($service["NAME"])?></span></a>
	<?endforeach?>
</div>
<?endif;?>
<div class="bx-auth">
