...
else
{
	...
	<div class="row col-md-12 col-sm-12">
		...
		{
			?>
			<a class="sale-order-history-link bxr-font-color bxr-border-color" href="<?=$APPLICATION->GetCurPageParam("filter_history=Y", $clearFromLink, false)?>">
		...
		{
			?>
			<a class="sale-order-history-link bxr-font-color bxr-border-color" href="<?=$APPLICATION->GetCurPageParam("", $clearFromLink, false)?>">
			...
			{
				?>
				<a class="sale-order-history-link bxr-font-color bxr-border-color" href="<?=$APPLICATION->GetCurPageParam("filter_history=Y&show_canceled=Y", $clearFromLink, false)?>">
	...
	if (!count($arResult['ORDERS']))
	{
		?>
		<div class="row col-md-12 col-sm-12">
			<a href="<?=htmlspecialcharsbx($arParams['PATH_TO_CATALOG'])?>" class="sale-order-history-link bxr-font-color bxr-border-color">
			...
			<div class="col-md-12 col-sm-12 sale-order-list-container">
				...
				<div class="row">
					<div class="col-md-12 sale-order-list-inner-container">
						...
						?>
						<div class="row sale-order-list-more-info">
							...
							<div class="sale-order-list-cancel-container">
								<a class="sale-order-list-cancel-link" href="<?=htmlspecialcharsbx($order["ORDER"]["URL_TO_CANCEL"])?>"><i class="fa fa-times" aria-hidden="true"></i><?=Loc::getMessage('SPOL_TPL_CANCEL_ORDER')?></a>
							</div>
							<div class="sale-order-list-repeat-container">
								<a class="sale-order-list-repeat-link" href="<?=htmlspecialcharsbx($order["ORDER"]["URL_TO_COPY"])?>"><i class="fa fa-undo" aria-hidden="true"></i><?=Loc::getMessage('SPOL_TPL_REPEAT_ORDER')?></a>
							</div>
						</div>
					</div>
				</div>
						...
						<div class="row sale-order-list-inner-row">
							...
							<div class="col-md-3 col-md-offset-6 col-sm-12 sale-order-list-repeat-accomplished">
								<a class="sale-order-list-repeat-link sale-order-link-accomplished" href="<?=htmlspecialcharsbx($order["ORDER"]["URL_TO_COPY"])?>">
									<i class="fa fa-undo" aria-hidden="true"></i><?=Loc::getMessage('SPOL_TPL_REPEAT_ORDER')?>
								</a>
							</div>
						</div>
					</div>
