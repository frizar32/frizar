...
$theme = (string)(isset($_REQUEST['theme']) ? $_REQUEST['theme'] : 'blue');
if ($theme === '')
	$theme = 'blue';
$themeClass = 'bx_'.$theme;
?>
		...
		<div class="bx_kit_one_section">
			...
			<div class="bx_kit_item" style="padding-top:0;">
				<div class="bx_kit_result <?if (!$setOldPrice && !$setPriceDiscountDifference):?>not_sale<?endif?>" id="bx_catalog_set_construct_price_block_<?=$curElementId?>">
					...
					<a href="javascript:void(0)" class="bxr-color-button" style="white-space: nowrap;" onclick="catalogSetPopupObj.Add2Basket();">
                                            <i class="fa fa-cart-plus"></i> <i class="hidden-xs">&nbsp;<?=$arMessage["CATALOG_SET_BUY"]?></i></span></a>
				</div>
			</div>
