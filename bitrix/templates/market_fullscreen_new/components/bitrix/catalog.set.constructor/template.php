...
<div class="bx_item_set_hor_container_big <? echo $templateData['TEMPLATE_CLASS']; ?>">
	...
	<div class="bx_item_set_hor">
		...
		<div class="bx_item_set_hor_item result">
			...
			<a href="javascript:void(0)" onclick="catalogSetDefaultObj_<? echo $intElementID; ?>.Add2Basket();" style="white-space: nowrap;" class="bxr-color-button">
				<i class="fa fa-cart-plus"></i>
				<?=GetMessage("CATALOG_SET_BUY")?></a>
		</div>

		<div style="clear: both;"></div>
	</div>
	<a class="bx_item_set_creator_link bxr-color-button" href="javascript:void(0)" onclick="OpenCatalogSetPopup('<?=$intElementID?>');"><?=GetMessage("CATALOG_SET_CONSTRUCT")?></a>
</div>
...
<script type="text/javascript">
	BX.message({
		...
		AddBasketTitle: '<?=GetMessage('CATALOG_SET_ADDED2BASKET')?>'
	});
