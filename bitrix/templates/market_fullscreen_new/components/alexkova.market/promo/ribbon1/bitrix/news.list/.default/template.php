...
<div class="row bxr-promo-ribbon bxr-promo-<?=$displayTypeClass?>">
    ...
    <?  foreach ($arResult['ITEMS'] as $arItem):  ?>
        ...
        <div id="<?=$this->GetEditAreaId($arItem['ID']);?>"
             class="bxr-promo-element col-lg-4 col-md-4 col-sm-4 col-xs-12 <?//=$arItem['PROPERTIES']["LG_COL_COUNT"]['VALUE_XML_ID']?> <?//=$arItem['PROPERTIES']["MD_COL_COUNT"]['VALUE_XML_ID']?> <?/*=$arItem['PROPERTIES']["SM_COL_COUNT"]['VALUE_XML_ID']*/?> <?//=$arItem['PROPERTIES']["XS_COL_COUNT"]['VALUE_XML_ID']?>">
                <?
