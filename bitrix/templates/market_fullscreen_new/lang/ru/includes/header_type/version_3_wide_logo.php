<div class="bxr-full-width bxr-container-headline head_v3_wide_logo <?=($BXReady->inverseHead) ? 'bxr-inverse':''?>">
    <div class="container">
        <div class="row headline">
            ...
            <div class="col-lg-6 col-md-6 hidden-sm hidden-xs content-left bxr-v-autosize">
               <?$APPLICATION->IncludeComponent(
