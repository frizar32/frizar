<div class="bxr-full-width bxr-container-headline head_v5_3 <?=($BXReady->inverseHead) ? 'bxr-inverse':''?>">
    <div class="container">
        <div class="row headline">
            ...
            <div class="col-lg-5 col-md-5 hidden-sm hidden-xs content-right bxr-v-autosize">
