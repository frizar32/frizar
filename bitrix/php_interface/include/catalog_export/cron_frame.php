...
<?php
/* replace /usr/local/php/bin/php to real path of php binary
For example:
/user/bin/php
/usr/bin/perl
/usr/bin/env python
*/
$_SERVER["DOCUMENT_ROOT"] = "/home/f/frizar/shop.frizar/public_html"; // replace /home/f/frizar/shop.frizar/public_html to real document root path
